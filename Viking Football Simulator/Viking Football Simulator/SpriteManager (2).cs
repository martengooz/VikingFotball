    ...
    public class SpriteManager : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            for (int i = 0; i < spriteList.Count; i++)
            {
                ...
                {
                    ((Game1)Game).PlaySound("Collition");
            ...
            if (spriteList.Count < 5)
            {
                spriteList.Add(new AutomatedSprite(
                    Game.Content.Load<Texture2D>(@"Images/skullball"),
                    new Vector2(slump.Next(1, 800), slump.Next(0, 450)), new Point(75, 75), 10, new Point(0, 0),
                    new Point(6, 8), new Vector2(slump.Next(100, 100) * 0.01, slump.Next(100, 100))));
            }
